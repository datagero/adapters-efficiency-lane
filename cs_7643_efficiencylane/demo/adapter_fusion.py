...
#     dataset_name = 'sciie',
#     seed = 1,
#     ad_lr=0.0003932385624289287,
#     batch_size = 32,
#     epochs = 15,
# )
# sciie_adapter_model = sciie_adapter_creator.create_and_save_adapter()

# # Roberta Base / Citation Intent 
